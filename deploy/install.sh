...
#   3) UPSTREAM_REPO=<git 地址>             从 git 拉（原上游仓库已不可访问，
#                                           需要指向你自己的副本 fork / 镜像）
#
...
if [ "$SKIP_UPSTREAM" -eq 1 ]; then
  ...
  #      自 2026-09-23 起已不可访问，源码由维护者随包分发）
